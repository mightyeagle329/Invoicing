  ...
  return (
    <ScrollArea className="h-dvh">
      <div className="flex flex-col gap-4 flex-1 px-2">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-5 gap-4">
              {overviewData.map((card) => (
                <Card key={card.id} className="bg-black text-antiFlashWhite">
                  <CardHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:h-72">
          <div className="col-span-2 border border-antiFlashWhite rounded-md p-4">
            <ResponsiveLine
              data={[
                {
                  color: "hsl(154, 70%, 50%)",
